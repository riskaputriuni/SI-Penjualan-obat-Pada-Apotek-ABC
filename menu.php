            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="?page=produk&actions=tampil">Produk</a></li>
                        <li><a href="?page=pembelian&actions=tampil">Pembelian</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Reports <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="?page=produk&actions=report">Laporan Produk</a></li>
						            <li><a href="?page=pembelian&actions=report">Laporan Pembelian</a></li>
                    </ul>
                </li>
