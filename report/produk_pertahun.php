            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <h4>Jalan Jalan Besar Desa Mekar Sari, Kabupaten Asahan, Sumatera Utara, 21261</h4>
                        <hr>
                        <h3>DATA PRODUK TAHUN   <? echo "$ambilthn"; ?></h3>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM tb_produkobat WHERE substr(kode_obat,1,4)='$ambilthn'";
