...
<html>
    <head>
        <title>Cetak Data Pembelian Obat Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA PEMBELIAN PRODUK OBAT BULAN   <? echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM tb_pembelian WHERE substr(jenis_pembelian,1,7)='$ambilthn-$ambilbln'";
