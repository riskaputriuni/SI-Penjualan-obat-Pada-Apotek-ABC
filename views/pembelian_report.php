        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="fa fa-user-plus"></span> Laporan Pembelian Produk</h3>
                </div>
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th>
                                <th width="17%">Jenis Pembelian</th>
                                <th>Nama Pembeli</th>
                                <th>Kode Obat</th>
                                <th>Harga Beli</th>
                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="report/pembelian_satu.php?id=<?= $data['id'] ?>" target="_blank" class="btn btn-info btn-xs">
                            ...
                            <tr>
                                <td colspan="9">
                                    <a href="report/pembelian_semua.php" target="_blank" class="btn btn-info btn-sm">
                                        <span class="fa fa_print"></span> Cetak Semua Data Pembelian Produk
